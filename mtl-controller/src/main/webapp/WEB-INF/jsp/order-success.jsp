...
<title>订单提交成功-麦淘乐 -  手机回收网 | 二手手机交易 | 笔记本回收 | 平板回收</title>
...
<script charset="utf-8" src="../js/new_js/lxb.js"></script><script charset="utf-8" src="../js/new_js/v.js"></script><script src="../js/hm.js"></script>
...
<div class="shortcut">
  <div class="page">
    ...
    <div class="shortcut-right">
      <ul id="login_show">
      		              <li><a href="http://www.ihuigo.com/member.html" rel="nofollow" title="1756229479@qq.com">1756229479@qq.com</a></li>
            <li class="my-cart"><a href="http://www.ihuigo.com/member.html" rel="nofollow"><em>我的回购</em></a>
              ...
              <a href="http://www.ihuigo.com/member/logout.html" rel="nofollow">退出</a> </div>
                            ...
                            <li class="item-daohang"><a class="item-daohang-nav" href="http://www.ihuigo.com/service/map.html" rel="nofollow" title="麦淘乐手机回收网站导航">网站导航</a>
        <div class="sub-nav2">
             <ul>
               <li>
                 <dl>
...
<!--               <li>-->
               <dl>
               <dt>客户服务</dt>
                   <dd><a href="http://www.ihuigo.com/service/terms.html" rel="nofollow" target="_blank" title="麦淘乐手机回收服务条款">服务条款</a></dd>
...
<!--    <h1 class="day" style="display:block;"><a href="/vr" rel="nofollow" target="_blank"><img src="--><!--images/new_images/day.gif" alt="" /></a></h1>-->
    <div class="nav">
    <a title="闲置二手手机回收估价" href="http://www.ihuigo.com/goods.html" class="on">
    <!--<span id="nav_xz">&nbsp;</span>-->闲置回收</a>
    <a title="二手手机以旧换新活动" href="http://www.ihuigo.com/huanxin.html"><!--<span id="nav_hx">&nbsp;</span>-->旧机换新<img src="../images/new.png"></a>
    <a title="靓机优选手机抢购" href="http://www.ihuigo.com/youpin.html"><!--<span id="nav_hx">&nbsp;</span>-->靓机优选</a><a target="_blank" href="http://www.ihuigo.com/kucun.html" rel="nofollow" style="margin-right:0;"><img src="../images/kc.gif" style="vertical-align:middle"></a>
  </div>
  </div>
</div>
<!--头部--><!--提交订单-->
<div class="contanier page">
  <div class="current"><a href="http://www.ihuigo.com/">首页</a><span>&gt;</span><em>订单提交成功</em></div>
  <!--提交订单-->
  <div class="process_main">
    <div class="sucess">
      <div class="sucess_t">
        <h2>恭喜，您的订单已提交成功！</h2>
        <p>订单号：HG181107668210  您选择的交易方式为
							<em>支付宝交易</em>，麦淘乐将对您的支付宝账号（18907181527）创建付款，付款后可在支付宝交易记录中查看本交易
						
		</p>
      </div>
      <div class="tips">
        <p>您享受麦淘乐的<em>72小时价格保护</em>服务</p>
        <p>请在<em>72小时之内发货</em>并在您的个人中心提交运单号，您的评估价格将不受市场影响而变动</p>
        <br>
        <p style="color:red;"><strong>温馨提示：建议您发出快递前，先对寄送机器（包装盒内）进行拍照留底，以备需要与快递核实寄件物品时，方便进行核对，感谢您的理解。</strong></p>
      </div>
	  	  
	  <!--                                     <div class="share_tan" ><a href="javascript:;" onclick="showMask()"><img src="/images/new_images/share.jpg" width="134" height="126" /></a></div>        
                    -->
        
    </div>
    <div class="title2"><strong>接下来您要做的是</strong></div>
    <div class="liucheng">
					<div class="liucheng"><span>包装好您的物品</span><em>&nbsp;</em><span>联系快递上门收件</span><em>&nbsp;</em><span>在个人中心点击发货 </span><em>&nbsp;</em><span>坐等收款</span></div>
				
		</div>
    <div class="liucheng_btn">
		<a href="http://www.ihuigo.com/member.html" class="liucheng_gr">进入个人中心</a>
		<a href="http://www.ihuigo.com/goods.html" class="liucheng_jx">继续回购</a>
	</div>
    <div class="localization">
      ...
      <div class="localization_r">
        <p>1、交易过程中，回收价格超过100元，物流费用由麦淘乐限额承担（保价、
          包装费除外）：回收价格低于100元，麦淘乐承担限额内一半邮费</p>
        <p>2、顺丰支持邮费到付，其他快递不支持。另外，麦淘乐建议尽量不要采用EMS邮寄。</p>
        <p>3、麦淘乐拒收非法所得的产品，一经发现，将拒绝回收，退货运费由用户自己承担</p>
        <p>4、山寨假冒数码建议环保回收，若用户要求退回，退回邮费由用户自己承担</p>
      </div>
      <div class="clear"></div>
    </div>
  </div>
...
<div id="mbDIV_members" style="display: none; height: 1161px;"></div>
<script type="text/javascript">
function login_pop(){
