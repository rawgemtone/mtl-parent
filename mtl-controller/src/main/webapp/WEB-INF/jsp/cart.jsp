...
<form name="myFrom" id="myFrom" method="post" action="/order/sub.html">
    ...
    <div class="contanier page">
                    ...
                    <div   id="new_member_addr_div">
                        ...
                        <ul class="contact_list">
                            ...
                            <li class="contact_texts"><span class="img_1"><img
                                    src="../images/in_1.gif"></span><span class="img_2"><input name="link_name" id="link_name" type="text"></span> <span class="img_1"><IMG src="../images/in_3.gif"></span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*</em></span> </li>
                            <div class="clear"></div>
                        </ul>
                        <ul class="contact_list">
                        ...
                        <div>
                            <ul class="contact_list">
                                ...
                                <li class="contact_texts"><span class="img_1"><img
                                        src="../images/in_1.gif"></span><span class="img_2_area"><input name="address" id="address" type="text"></span> <span class="img_1"><IMG src="../images/in_3.gif"></span></li>
                                <div class="clear"></div>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="sub_con_foot">
                    ...
                    <div  id="new_member_alipay_div">
                        ...
                        <ul class="contact_list">
                            ...
                            <li class="contact_texts"><span class="img_1"><img
                                    src="../images/in_1.gif"></span><span class="img_2"><input name="alipay_realname" id="alipay_realname" type="text" value=""></span> <span class="img_1"><IMG src="../images/in_3.gif"></span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*</em></span> </li>
                            <div class="clear"></div>
                        </ul>
                        ...
                        <ul class="contact_list">
                            ...
                            <li class="contact_texts"><span class="img_1"><img
                                    src="../images/in_1.gif"></span><span class="img_2"><input name="alipay_username" id="alipay_username" type="text" value="" ></span> <span class="img_1"><IMG src="../images/in_3.gif"></span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*亲，必须是实名认证的支付宝账号哦！</em></span> </li>
                            <div class="clear"></div>
                        </ul>
                    </div>
      ...
      您可选择<a href="http://www.ihuigo.com/html/baoxian.html" style="background:none; padding:0px; color:#03F; font-weight:bold;" target="_blank">参与中国人民财产保险投保计划</a></span>
            ...
            <input type="button" name="sub_button" id="sub_button" value="提交回购单" class="input_btn2" onclick="return checkfrom()" />
        </div>
    ...
    <div class="dingdan">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1"  class="table1">
            ...
            <tr>
                <td height="95" align="center">
                    ...
                    <div class="contact_way_txt"><p><span>iphone 7</span></p></div>
                    <div class="clear"></div>
                </td>
        ...
        <div class="foot_bor"> <em>1</em>件产品总计回收价格<em style="font-size:18px;">￥2800</em> <!--<span>赠送环保券 <i>30</i>元--></span></div>
    </div>
    <!--订单-->
    </div>
    <!--提交订单-->
