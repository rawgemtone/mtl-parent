...
<meta name="description" content="麦淘乐是一家专业安全的二手手机回收网，为您提供在线手机回收、平板电脑回收、笔记本回收、数码相机回收、相机镜头回收、无人机回收，专业手机回收价格评估，让你轻松买卖二手手机等闲置数码产品。">
...
<script charset="utf-8" src="../js/new_js/lxb.js"></script><script charset="utf-8" src="../js/new_js/v.js"></script><script src="../js/hm.js"></script><script src="../js/jquery-1.11.1.min.js" type="text/javascript"></script>
...
<div class="shortcut">
  <div class="page">
    ...
    <div class="shortcut-right">
      <ul id="login_show">
      		              <li><a href="http://www.qfedu.com/member.html" rel="nofollow" title="1756229479@qq.com">1756229479@qq.com</a></li>
            <li class="my-cart"><a href="http://www.qfedu.com/member.html" rel="nofollow"><em>我的回购</em></a>
              <div class="sub-cart">
              <a href="http://www.qfedu.com/member/order.html" rel="nofollow">我的订单</a>
              <a href="http://www.qfedu.com/member.html" rel="nofollow">帐户中心</a>
              <a href="http://www.qfedu.com/member/juan.html" rel="nofollow">环保券<i>0</i>张</a>
              <a href="http://www.qfedu.com/member/logout.html" rel="nofollow">退出</a> </div>
            </li>
                            <li class="item-daohang"><a class="item-daohang-nav" href="http://www.qfedu.com/service/map.html" rel="nofollow" title="麦淘乐手机回收网站导航">网站导航</a>
        <div class="sub-nav2">
             <ul>
               <li>
                 <dl>
                   <dt>主要频道</dt>
                   <dd><a target="_blank" href="http://www.qfedu.com/goods.html" title="闲置二手手机回收价格评估">旧机回收</a></dd>
                   <dd><a target="_blank" href="http://www.qfedu.com/youpin.html" title="靓机优选手机抢购">靓机优选</a></dd>
                   <dd><a target="_blank" href="http://www.qfedu.com/huanxin.html" title="二手手机以旧换新活动">旧机换新</a></dd>
                   </dl>
               </li>
<!--               <li>-->
<!--               <dl>-->
...
<!--               <li>-->
               <dl>
               <dt>客户服务</dt>
                   <dd><a href="http://www.qfedu.com/service/terms.html" rel="nofollow" target="_blank" title="麦淘乐手机回收服务条款">服务条款</a></dd>
                   <dd><a href="http://www.qfedu.com/service/suggestions.html" rel="nofollow" target="_blank" title="手机回收问题投诉与建议">投诉建议</a></dd>
...
<div class="search_list">
  <div class="page">
    <div class="current"><a href="http://www.qfedu.com/">首页</a><span>&gt;</span><a href="http://www.qfedu.com/member.html">会员中心</a></div>
    <!--会员中心-->
    <div class="member"> 
...
<dl class="member_l_list">
  ...
  <dd><a href="http://www.qfedu.com/member/order.html"><b class="item2">&nbsp;</b><em>回购订单</em><!--<span>1</span>--></a></dd>
  <dd><a href="http://www.qfedu.com/personal/buy_order.html"><b class="item6">&nbsp;</b><em>购买订单</em></a></dd>
  <dd><a href="http://www.qfedu.com/personal/huan_order.html"><b class="item7">&nbsp;</b><em>换新订单</em><span style="display: none;">2</span></a></dd>
   
   <dd><a href="http://www.qfedu.com/spike_order/spike_buy_order.html"><b class="item8">&nbsp;</b><em>活动订单</em></a></dd>
   <!--<dd  ><a href="/personal/vr_order.html"><b class="item9">&nbsp;</b><em>VR订单</em></a></dd>-->
   <dd><a href="http://www.qfedu.com/member/juan.html"><b class="item3">&nbsp;</b><em>我的优惠券</em></a></dd>
  <dd><a href="http://www.qfedu.com/member/address.html"><b class="item4">&nbsp;</b><em>地址管理</em></a></dd>
  <dd><a href="http://www.qfedu.com/member/message.html"><b class="item5">&nbsp;</b><em>消息中心</em><!--<span>2</span>--></a></dd>
</dl>
</div>
<!--会员中心列表-->
      <div class="member_r2">
...
<div class="section3" id="process">
	<div class="fore1 ready">
	 <div class="tx1">&nbsp;</div>
	  <ul>
		 ...
		 <li class="tx3" id="track_time_0">2018-11-22 <br> 10:45:33</li>
	  </ul>
	...
	<div class="tx1 tx1_on">2</div>
	  <ul>
		<li class="tx2 tx2_on">等待麦淘乐创建担保交易并付款</li>
...
<!--支付宝当面交易进度条end-->	            <div class="face_zt_info">
			  ...
			  <input type="hidden" name="sn" value="HG181122668662">
  			  <input type="hidden" name="validate_code" value="b6929340e8a796a03ff42f3bcd3d01d7">
              <!--选择快递-->
            ...
            <div class="clear"></div>
              ...
              <div class="localization">
                ...
                <div class="localization_l">
                  <ul>
                    <li><span>收 件 人</span>麦淘乐(韦杰)</li>
                    <li><span>收件地址</span>深圳市南山区桃源街道光前村工业区20栋启龙中心603室</li>
                    <li><span>联系电话</span>400-9608-558</li>
                  </ul>
                </div>
                <div class="localization_r">
                  <p>1、交易过程中，回收价格超过100元，物流费用由
   麦淘乐限额承担（保价、包装费除外）：回收价
   格低于100元，麦淘乐承担限额内一半邮费</p>
...
<script type="text/javascript">
$(document).ready(
timer('259122','','hour','minute','second')
)
</script>
                  <div class="colockbox" id="demo02"><span class="hour" id="hour">71</span><span class="minute" id="minute">56</span><span class="second" id="second">27</span>
...
<div class="transaction_main">
  <div class="face_bh">
	<p><span>订单编号：HG181122668662</span><span>提交时间：2018-11-22 10:45</span></p>
	<p><span>联系电话：18907181527</span><span>交易方式：支付宝</span>
			<span style="width:400px;">支付宝账号：18907181527</span>
		</p>
  </div>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table2">
	<tbody><tr>
	  ...
	  <th height="24" align="center" style="text-align:center" width="60%">评估描述</th>
			...
			<tr>
	  <td height="110"><a href="http://www.qfedu.com/goods/info/21026.html" target="_blank"><img src="../images/c4c230d6e47a93ea1e92654d87222716.jpg" width="112" height="84"></a>
		<div class="table2_txtsd">iphone 7plus</div>
		<div class="clear"></div></td>
	  <td>￥<em>2165.00</em></td>
	  <td><p class="table2_p2">
								&nbsp;<span>大陆行货</span>&nbsp;
				|&nbsp;<span>保修一个月以上</span>&nbsp;
				<br>
				...
				|&nbsp;<span>按键接口及卡槽正常</span>&nbsp;
				|&nbsp;<span>指纹功能正常</span>&nbsp;
				|&nbsp;<span>蓝牙/wifi功能正常</span>&nbsp;
				|&nbsp;<span>照相及感光功能正常</span>&nbsp;
				|&nbsp;<span>传感器正常</span>&nbsp;
				|&nbsp;<span>通话功能正常</span>&nbsp;
				|&nbsp;<span>iCloud账号可以解除</span>&nbsp;
				|&nbsp;<span>外壳完好，无划痕磕碰</span>&nbsp;
				|&nbsp;<span>32G</span>&nbsp;
				|&nbsp;<span>A1661</span>&nbsp;
				|&nbsp;<span>机身无变形</span>&nbsp;
						</p></td>
...
<!--在线客服-->
 ...
 <div class="mui-mbar-go"><a href="http://www.qfedu.com/service/suggestions.html" rel="nofollow" target="_blank"><img src="../images/cart_icon2.png"></a></div>
 <div class="mui-weima"><a href="http://www.qfedu.com/service/suggestions.html" rel="nofollow" target="_blank"><img src="../images/weixin.png" width="192" height="192"></a></div>
 </div>
 <!--微信二维码-->
 <!--投诉建议-->
 <div class="mui-mbar-tousu mui-mbar-all">
 <div class="mui-mbar-go"><a href="http://www.qfedu.com/service/suggestions.html" rel="nofollow" target="_blank"><img src="../images/cart_icon3.png"></a></div>
	 ...
	 <div class="tyd_box">
	  <div class="tyd_box_c">
		...
		<div class="tyd_box_content" style="width:524px;height:529px; overflow:hidden">
			<iframe id="Loading_server_iframe_id" name="iframe_id" width="524" height="529" border="0" frameborder="0" src="saved_resource.html"></iframe>
		</div>
	  </div>
	</div>
</div>
	 ...
	 <div class="tyd_box">
	  <div class="tyd_box_c">
		...
		<div class="tyd_box_content" style="width:502px;overflow:auto; height:570px;;">
			<iframe id="Loading_child_members_iframe_id" name="iframe_id" width="502" height="570px;" border="0" frameborder="0" src="../saved_resource(2).html"></iframe>
		</div>
	  </div>
	</div>
</div>
